...
--
-- Host: 127.0.0.1
-- Tempo de geração: 10/12/2024 às 16:44
...
(5, 21, '2018-01-01', 'Joao Almeida', 'Lucio'),
(12, 23, '2017-12-31', 'Gabriel', 'Japa'),
(9, 24, '2017-12-31', 'sfdzxcfvzsxf', 'asdasdfas'),
(1, 26, '2018-01-01', 'Felipe', 'Lucio');
...
('07:55:00', 'Segunda-Feira', 1, 5, 7, 15),
('09:45:00', 'Terca-Feira', 1, 1, 4, 16),
('09:45:00', 'Quarta-Feira', 3, 5, 22, 17);
...
--
ALTER TABLE `boletim`
  MODIFY `idBoletim` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
