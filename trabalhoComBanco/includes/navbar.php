    ...
    <ul>
        <?php if (isset($_SESSION['usuario'])): ?>
            <?php if ($_SESSION["funcao"] == "aluno"): ?>
                <li><a href="../aluno/controller-aluno-boletim.php" class="my-area-button">Minha Área</a></li>
                <li><a href="../aluno/controller-aluno-tabela.php">Horário das aulas</a></li>
            <?php elseif ($_SESSION["funcao"] == "professor"): ?>
                <li><a href="../professor/controller-professor.php" class="my-area-button">Minha Área</a></li>
